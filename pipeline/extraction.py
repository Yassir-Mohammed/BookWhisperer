...
from settings.extraction_settings import *
...
def do_parse(
    ...
    p_lang_list: list[str] = DOC_LANGUAGE_LIST,
    backend="pipeline",  # The backend for parsing PDF, default is 'pipeline'
    parse_method="auto",  # The method for parsing PDF, default is 'auto'
    formula_enable=PARSE_FORMULA,  # Enable formula parsing
    table_enable=PARSE_TABLE,  # Enable table parsing
    server_url=None,  # Server URL for vlm-http-client backend
    # Whether to draw layout bounding boxes
    f_draw_layout_bbox=DRAW_LAYOUT_IDENTIFICATION_BOX,
    # Whether to draw span bounding boxes
    f_draw_span_bbox=DRAW_TEXT_IDENTIFICATION_BOX,
    f_dump_md=True,  # Whether to dump markdown files
    f_dump_middle_json=True,  # Whether to dump middle JSON files
    f_dump_model_output=True,  # Whether to dump model output files
    f_dump_orig_pdf=DUMP_ORIGINAL_FILE,  # Whether to dump original PDF files
